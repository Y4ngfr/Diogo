...
std::array<double, 2> Transport::get_collection_address()
{
    /*
...
std::array<double, 2> Transport::get_delivery_address()
{
    /*
...
std::ostream &operator<<(std::ostream &os, const Transport *transport)
{
    ...
    os << "Collection Address: " << transport->collection_address[0] 
    << ", " << transport->collection_address[1] << "\n";

    os << "Delivery Address: " << transport->delivery_address[0] 
    << ", " << transport->delivery_address[1] << "\n";
